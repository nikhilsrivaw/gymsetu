...
export default function MemberLayout() {
  ...
  if (isLoading) return <View style={{
    ...
    alignItems: 'center'
  }}><ActivityIndicator color={Colors.accent} /></View>;
  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      ...
      >
        ...
        <Drawer.Screen name="workout-tracker" options={{
          title:
        ...
        <Drawer.Screen name="exercise-library" options={{
          title:
        ...
        <Drawer.Screen name="bmi-calculator" options={{
          title:
